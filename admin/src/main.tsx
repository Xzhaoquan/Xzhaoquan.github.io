...
function SeoChecks({ report, onOpen, onFix }: { report: SeoReport | null; onOpen: (article: SeoReport['articles'][number]) => void; onFix: (article: SeoReport['articles'][number], action: 'summary' | 'date' | 'image-alt' | 'all') => void }) {
