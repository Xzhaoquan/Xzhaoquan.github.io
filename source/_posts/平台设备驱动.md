...
tags: Linux驱动开发
excerpt: <p>平台设备驱动 平台总线-Linux内核引进的一种虚拟总线（platfrom bus） 使用platfrom bus
  type来描述平台总线 平台设备总线在Linux启动时自动注册 平台总线采用platform match函数去匹配平台设备和平台驱动
  平台设备去匹配设备可以通过四种方式： - 通过设备树机制去进行匹配 -</p>
---
