...
tags: Linux驱动开发
excerpt: <p>字符设备 - 设备号的定义 - 使用register chrdev region函数静态申请设备号 - 调用alloc chrdev
  region函数动态的申请设备号 - 注销申请的字符设备号 - register chrdev函数申请设备号 - unregister
  chrdev注销申请的字符设备号 - 设备号宏 -</p>
---
